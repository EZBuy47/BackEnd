...
MongoClient.connect(
  "mongodb+srv://admin:admin@cluster0.bs9d2.mongodb.net/test?retryWrites=true&w=majority",
...
MongoClient.connect(
  ...
  .then((client) => {
    ...
    /*Devuelve todos las ventas registradas*/
    ...
    //Retorna una sola venta dada una id
    app.get("/salesbyid/:id", (req, res) => {
      const id = req.params.id;
      var ObjectId = require("mongodb").ObjectId;
      var o_id = new ObjectId(id);
      db.collection("products").findOne({ _id: o_id }, function (err, result) {
    ...
    app.delete("/deletesale/:id", (req, res) => {
      ...
      db.collection("sales")
        ...
        .then((result) => {
          res.send("Borrado Exitoso");
          console.log("Borrado venta Exitoso");
        })
        .catch((error) => console.log(error));
    });
  })
